...
class Sidebar extends React.Component {
  ...
  render() {
    ...
    const sections = this.sections.map(section => {
      ...
      return (<HideableComponent key={section.id} allPreferences={preferences} field={section}>
    ...
    return (<ul className='sidebar' role='tablist' aria-label='Side bar' onKeyDown={this.onTablistKeyDown}>
        {sections}
      </ul>);
