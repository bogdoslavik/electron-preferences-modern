        ...
        return (
            <div className={`field field-secret key-${this.field.key}`}>
                ...
                <div className="input-button-container">
                    ...
                    <button
                        className="bt"
                        onClick={this.changeSecret.bind(this)}
                    >
                        Change
                    </button>
                </div>
                ...
                >
                    <div className="secret-modal">
                        ...
                        <div className="buttons">
                            <button
                                className="bt"
                                onClick={this.saveSecret.bind(this)}
                            >
                                Save
                            </button>
                            <button
                                className="bt"
                                onClick={this.resetSecret.bind(this)}
                            >
                                Reset
                            </button>
                            <button
                                className="bt"
                                onClick={this.cancelSecret.bind(this)}
                            >
                                Cancel
                            </button>
                        </div>
