...
const preferences = new ElectronPreferences({
	...
	},
	{
		...
		form: {
			...
			{
				label: 'Group 1',
				hideFunction: preferences => preferences.sectionsEnabler?.group1 === 'false',
				fields: [ {
					heading: 'Group 1',
			...
			{
				label: 'Group 2',
				hideFunction: preferences => !preferences.sectionsEnabler?.group2,
				fields: [ {
					heading: 'Group 1',
					content: '<p>Placeholder for group 1</p>',
					type: 'message',
	...
	},
	{
		...
		label: 'Theme',
		icon: 'Sun',
		hideFunction: preferences => !preferences.sectionsEnabler?.theme,
		form: {
			groups: [ {
				fields: [ {
					label: 'Theme',
