...
- Icons for preference groups (via [Lucide](https://lucide.dev))
- Default values
- Hidden values
...
Icons are provided by [Lucide React](https://lucide.dev/guide/packages/lucide-react). Specify the icon name in your section configuration:

```js
{ id: "about", label: "About You", icon: "User", ... }
```

Refer to [Lucide's icon list](https://lucide.dev/icons) for all available names.
